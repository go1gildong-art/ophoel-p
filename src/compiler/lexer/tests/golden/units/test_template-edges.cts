...
export const unit = new UnitCase(
    ...
    [
        ...
        'TMPL_PART <  > template-edges.oph:1:13 (4)',
        ...
        'TMPL_PART < foo > template-edges.oph:2:13 (11)',
        ...
        'TMPL_PART < a > template-edges.oph:3:13 (18)',
